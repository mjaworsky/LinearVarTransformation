...
which(colnames(state_data)=="CNCRDIFF")
#156
which(colnames(state_data)=="CNCRTYP1")
#158

unique(state_data[156])
#      CNCRDIFF
#1          NaN
#51662        1
#51695        2
...
unique(state_data[157])

unique(state_data[158])
#       CNCRTYP1
#1           NaN
#51662        22
#51664        10
...
state_data[158][state_data[158] == 2] <- '2'
state_data[158][state_data[158] == 3] <- '3'
state_data[158][state_data[158] == 4] <- '4'
state_data[158][state_data[158] == 5] <- '5'
state_data[158][state_data[158] == 6] <- '6'
state_data[158][state_data[158] == 7] <- '7'
state_data[158][state_data[158] == 8] <- '8'
state_data[158][state_data[158] == 9] <- '9'
state_data[158][state_data[158] == 10] <- '10'
state_data[158][state_data[158] == 11] <- '11'
state_data[158][state_data[158] == 12] <- '12'
state_data[158][state_data[158] == 13] <- '13'
state_data[158][state_data[158] == 14] <- '14'
state_data[158][state_data[158] == 15] <- '15'
state_data[158][state_data[158] == 16] <- '16'
state_data[158][state_data[158] == 17] <- '17'
state_data[158][state_data[158] == 18] <- '18'
state_data[158][state_data[158] == 19] <- '19'
state_data[158][state_data[158] == 20] <- '20'
state_data[158][state_data[158] == 21] <- '21'
state_data[158][state_data[158] == 22] <- '22'
state_data[158][state_data[158] == 23] <- '23'
state_data[158][state_data[158] == 24] <- '24'
state_data[158][state_data[158] == 25] <- '25'
state_data[158][state_data[158] == 26] <- '26'
state_data[158][state_data[158] == 27] <- '27'
state_data[158][state_data[158] == 28] <- '28'
state_data[158][state_data[158] == 29] <- '29'
state_data[158][state_data[158] == 30] <- '30'
...
state_data['STRESS_00'] <- 0
state_data['STRESS_01'] <- 0
state_data['STRESS_02'] <- 0
state_data['STRESS_03'] <- 0
state_data['STRESS_04'] <- 0                                  
state_data['STRESS_05'] <- 0
state_data['STRESS_06'] <- 0
state_data['STRESS_07'] <- 0
state_data['STRESS_08'] <- 0
state_data['STRESS_09'] <- 0
state_data['STRESS_10'] <- 0
state_data['STRESS_11'] <- 0
state_data['STRESS_12'] <- 0
state_data['STRESS_13'] <- 0
state_data['STRESS_14'] <- 0
state_data['STRESS_15'] <- 0
state_data['STRESS_16'] <- 0
state_data['STRESS_17'] <- 0
state_data['STRESS_18'] <- 0
state_data['STRESS_19'] <- 0
state_data['STRESS_20'] <- 0
state_data['STRESS_21'] <- 0
state_data['STRESS_22'] <- 0
state_data['STRESS_23'] <- 0
state_data['STRESS_24'] <- 0
state_data['STRESS_25'] <- 0
state_data['STRESS_26'] <- 0

state_data['DEPRESSION_00'] <- 0
state_data['DEPRESSION_01'] <- 0
state_data['DEPRESSION_02'] <- 0
state_data['DEPRESSION_03'] <- 0
state_data['DEPRESSION_04'] <- 0                                  
state_data['DEPRESSION_05'] <- 0
state_data['DEPRESSION_06'] <- 0
state_data['DEPRESSION_07'] <- 0
state_data['DEPRESSION_08'] <- 0
state_data['DEPRESSION_09'] <- 0
state_data['DEPRESSION_10'] <- 0
state_data['DEPRESSION_11'] <- 0
state_data['DEPRESSION_12'] <- 0
state_data['DEPRESSION_13'] <- 0
state_data['DEPRESSION_14'] <- 0
state_data['DEPRESSION_15'] <- 0
state_data['DEPRESSION_16'] <- 0
state_data['DEPRESSION_17'] <- 0
state_data['DEPRESSION_18'] <- 0
state_data['DEPRESSION_19'] <- 0
state_data['DEPRESSION_20'] <- 0
state_data['DEPRESSION_21'] <- 0
state_data['DEPRESSION_22'] <- 0
state_data['DEPRESSION_23'] <- 0
state_data['DEPRESSION_24'] <- 0
state_data['DEPRESSION_25'] <- 0
state_data['DEPRESSION_26'] <- 0
 

state_data['ASTHMA_00'] <- 0
state_data['ASTHMA_01'] <- 0
state_data['ASTHMA_02'] <- 0
state_data['ASTHMA_03'] <- 0
state_data['ASTHMA_04'] <- 0                                  
state_data['ASTHMA_05'] <- 0
state_data['ASTHMA_06'] <- 0
state_data['ASTHMA_07'] <- 0
state_data['ASTHMA_08'] <- 0
state_data['ASTHMA_09'] <- 0
state_data['ASTHMA_10'] <- 0
state_data['ASTHMA_11'] <- 0
state_data['ASTHMA_12'] <- 0
state_data['ASTHMA_13'] <- 0
state_data['ASTHMA_14'] <- 0
state_data['ASTHMA_15'] <- 0
state_data['ASTHMA_16'] <- 0
state_data['ASTHMA_17'] <- 0
state_data['ASTHMA_18'] <- 0
state_data['ASTHMA_19'] <- 0
state_data['ASTHMA_20'] <- 0
state_data['ASTHMA_21'] <- 0
state_data['ASTHMA_22'] <- 0
state_data['ASTHMA_23'] <- 0
state_data['ASTHMA_24'] <- 0
state_data['ASTHMA_25'] <- 0
state_data['ASTHMA_26'] <- 0
...
state_data['HEPC_00'] <- 0
state_data['HEPC_01'] <- 0
state_data['HEPC_02'] <- 0
state_data['HEPC_03'] <- 0
state_data['HEPC_04'] <- 0                                  
state_data['HEPC_05'] <- 0
state_data['HEPC_06'] <- 0
state_data['HEPC_07'] <- 0
state_data['HEPC_08'] <- 0
state_data['HEPC_09'] <- 0
state_data['HEPC_10'] <- 0
state_data['HEPC_11'] <- 0
state_data['HEPC_12'] <- 0
state_data['HEPC_13'] <- 0
state_data['HEPC_14'] <- 0
state_data['HEPC_15'] <- 0
state_data['HEPC_16'] <- 0
state_data['HEPC_17'] <- 0
state_data['HEPC_18'] <- 0
state_data['HEPC_19'] <- 0
state_data['HEPC_20'] <- 0
state_data['HEPC_21'] <- 0
state_data['HEPC_22'] <- 0
state_data['HEPC_23'] <- 0
state_data['HEPC_24'] <- 0
state_data['HEPC_25'] <- 0
state_data['HEPC_26'] <- 0

# TOLDHEPC 

state_data['HEPB_00'] <- 0
state_data['HEPB_01'] <- 0
state_data['HEPB_02'] <- 0
state_data['HEPB_03'] <- 0
state_data['HEPB_04'] <- 0                                  
state_data['HEPB_05'] <- 0
state_data['HEPB_06'] <- 0
state_data['HEPB_07'] <- 0
state_data['HEPB_08'] <- 0
state_data['HEPB_09'] <- 0
state_data['HEPB_10'] <- 0
state_data['HEPB_11'] <- 0
state_data['HEPB_12'] <- 0
state_data['HEPB_13'] <- 0
state_data['HEPB_14'] <- 0
state_data['HEPB_15'] <- 0
state_data['HEPB_16'] <- 0
state_data['HEPB_17'] <- 0
state_data['HEPB_18'] <- 0
state_data['HEPB_19'] <- 0
state_data['HEPB_20'] <- 0
state_data['HEPB_21'] <- 0
state_data['HEPB_22'] <- 0
state_data['HEPB_23'] <- 0
state_data['HEPB_24'] <- 0
state_data['HEPB_25'] <- 0
state_data['HEPB_26'] <- 0

# HAVEHEPB

state_data['HEART_00'] <- 0
state_data['HEART_01'] <- 0
state_data['HEART_02'] <- 0
state_data['HEART_03'] <- 0
state_data['HEART_04'] <- 0                                  
state_data['HEART_05'] <- 0
state_data['HEART_06'] <- 0
state_data['HEART_07'] <- 0
state_data['HEART_08'] <- 0
state_data['HEART_09'] <- 0
state_data['HEART_10'] <- 0
state_data['HEART_11'] <- 0
state_data['HEART_12'] <- 0
state_data['HEART_13'] <- 0
state_data['HEART_14'] <- 0
state_data['HEART_15'] <- 0
state_data['HEART_16'] <- 0
state_data['HEART_17'] <- 0
state_data['HEART_18'] <- 0
state_data['HEART_19'] <- 0
state_data['HEART_20'] <- 0
state_data['HEART_21'] <- 0
state_data['HEART_22'] <- 0
state_data['HEART_23'] <- 0
state_data['HEART_24'] <- 0
state_data['HEART_25'] <- 0
state_data['HEART_26'] <- 0


state_data['AGE65UP_00'] <- 0
state_data['AGE65UP_01'] <- 0
state_data['AGE65UP_02'] <- 0
state_data['AGE65UP_03'] <- 0
state_data['AGE65UP_04'] <- 0                                  
state_data['AGE65UP_05'] <- 0
state_data['AGE65UP_06'] <- 0
state_data['AGE65UP_07'] <- 0
state_data['AGE65UP_08'] <- 0
state_data['AGE65UP_09'] <- 0
state_data['AGE65UP_10'] <- 0
state_data['AGE65UP_11'] <- 0
state_data['AGE65UP_12'] <- 0
state_data['AGE65UP_13'] <- 0
state_data['AGE65UP_14'] <- 0
state_data['AGE65UP_15'] <- 0
state_data['AGE65UP_16'] <- 0
state_data['AGE65UP_17'] <- 0
state_data['AGE65UP_18'] <- 0
state_data['AGE65UP_19'] <- 0
state_data['AGE65UP_20'] <- 0
state_data['AGE65UP_21'] <- 0
state_data['AGE65UP_22'] <- 0
state_data['AGE65UP_23'] <- 0
state_data['AGE65UP_24'] <- 0
state_data['AGE65UP_25'] <- 0
state_data['AGE65UP_26'] <- 0

state_data['MULTICANCER_00'] <- 0
state_data['MULTICANCER_01'] <- 0
state_data['MULTICANCER_02'] <- 0
state_data['MULTICANCER_03'] <- 0
state_data['MULTICANCER_04'] <- 0                                  
state_data['MULTICANCER_05'] <- 0
state_data['MULTICANCER_06'] <- 0
state_data['MULTICANCER_07'] <- 0
state_data['MULTICANCER_08'] <- 0
state_data['MULTICANCER_09'] <- 0
state_data['MULTICANCER_10'] <- 0
state_data['MULTICANCER_11'] <- 0
state_data['MULTICANCER_12'] <- 0
state_data['MULTICANCER_13'] <- 0
state_data['MULTICANCER_14'] <- 0
state_data['MULTICANCER_15'] <- 0
state_data['MULTICANCER_16'] <- 0
state_data['MULTICANCER_17'] <- 0
state_data['MULTICANCER_18'] <- 0
state_data['MULTICANCER_19'] <- 0
state_data['MULTICANCER_20'] <- 0
state_data['MULTICANCER_21'] <- 0
state_data['MULTICANCER_22'] <- 0
state_data['MULTICANCER_23'] <- 0
state_data['MULTICANCER_24'] <- 0
state_data['MULTICANCER_25'] <- 0
state_data['MULTICANCER_26'] <- 0
...
#state_data1 = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,GENDER_00,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26))
#
#state_data1[is.na(state_data1)] <- 0
#
#write.csv(state_data1, "LLCP2021XPT_LINEAR_GENDER.csv")

#> substr(LM_WHOICD_KG_SORTED[,1][LM_WHOICD_KG_SORTED$word == 'asthma'],1,5)
#[1] "CH_00" "CH_01" "CH_04" "CH_12" "CH_14" "CH_24"
#
#> LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'asthma']
#[1]  1  1  4 45  1  1


state_data$ASTHMA_00[state_data$ASTHMA3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'asthma'][1]
state_data$ASTHMA_01[state_data$ASTHMA3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'asthma'][2]
state_data$ASTHMA_04[state_data$ASTHMA3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'asthma'][3] 
state_data$ASTHMA_12[state_data$ASTHMA3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'asthma'][4]
state_data$ASTHMA_14[state_data$ASTHMA3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'asthma'][5] 
state_data$ASTHMA_24[state_data$ASTHMA3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'asthma'][6]


#state_data = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,ASTHMA_01,ASTHMA_02,ASTHMA_03,ASTHMA_04,ASTHMA_05,ASTHMA_06,ASTHMA_07,ASTHMA_08,ASTHMA_09,ASTHMA_10,ASTHMA_11,ASTHMA_12,ASTHMA_13,ASTHMA_14,ASTHMA_15,ASTHMA_16,ASTHMA_17,ASTHMA_18,ASTHMA_19,ASTHMA_20,ASTHMA_21,ASTHMA_22,ASTHMA_23,ASTHMA_24,ASTHMA_25,ASTHMA_26))
#
#state_data[is.na(state_data)] <- 0
##
#write.csv(state_data, "LLCP2021XPT_LINEAR_ASTHMA.csv")
...
#state_data = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,LABEL_00,LABEL_01,LABEL_02,LABEL_03,LABEL_04,LABEL_05,LABEL_06,LABEL_07,LABEL_08,LABEL_09,LABEL_10,LABEL_11,LABEL_12,LABEL_13,LABEL_14,LABEL_15,LABEL_16,LABEL_17,LABEL_18,LABEL_19,LABEL_20,LABEL_21,LABEL_22,LABEL_23,LABEL_24,LABEL_25,LABEL_26,PDTEST_01,PDTEST_02,PDTEST_03,PDTEST_04,PDTEST_05,PDTEST_06,PDTEST_07,PDTEST_08,PDTEST_09,PDTEST_10,PDTEST_11,PDTEST_12,PDTEST_13,PDTEST_14,PDTEST_15,PDTEST_16,PDTEST_17,PDTEST_18,PDTEST_19,PDTEST_20,PDTEST_21,PDTEST_22,PDTEST_23,PDTEST_24,PDTEST_25,PDTEST_26))
#
#
#write.csv(state_data, "LLCP2021XPT_LINEAR_DIABETES.csv")
...
#state_data1 = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,WEIGHT_00,WEIGHT_01,WEIGHT_02,WEIGHT_03,WEIGHT_04,WEIGHT_05,WEIGHT_06,WEIGHT_07,WEIGHT_08,WEIGHT_09,WEIGHT_10,WEIGHT_11,WEIGHT_12,WEIGHT_13,WEIGHT_14,WEIGHT_15,WEIGHT_16,WEIGHT_17,WEIGHT_18,WEIGHT_19,WEIGHT_20,WEIGHT_21,WEIGHT_22,WEIGHT_23,WEIGHT_24,WEIGHT_25,WEIGHT_26))

#state_data1[is.na(state_data1)] <- 0

#write.csv(state_data1, "LLCP2021XPT_LINEAR_WEIGHT.csv")
...
#state_data1 = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26))

#state_data1[is.na(state_data1)] <- 0

#write.csv(state_data1, "LLCP2021XPT_LINEAR_SMOKING.csv")


#substr(LM_WHOICD_KG_SORTED[,1][LM_WHOICD_KG_SORTED$word == 'pain'],1,5)
#
...
#
#state_data = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,DRINK_01,DRINK_02,DRINK_03,DRINK_04,DRINK_05,DRINK_06,DRINK_07,DRINK_08,DRINK_09,DRINK_10,DRINK_11,DRINK_12,DRINK_13,DRINK_14,DRINK_15,DRINK_16,DRINK_17,DRINK_18,DRINK_19,DRINK_20,DRINK_21,DRINK_22,DRINK_23,DRINK_24,DRINK_25,DRINK_26))
#
#
#write.csv(state_data, "LLCP2021XPT_LINEAR_PAIN.csv")
...
#state_data = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

#write.csv(state_data, "LLCP2021XPT_LINEAR_PHYSICAL.csv")

#substr(LM_WHOICD_KG_SORTED[,1][LM_WHOICD_KG_SORTED$word == 'fatigue'],1,5)

#> substr(LM_WHOICD_KG_SORTED[,1][LM_WHOICD_KG_SORTED$word == 'stress'],1,5)
# [1] "CH_00" "CH_01" "CH_03" "CH_05" "CH_06" "CH_08" "CH_11" "CH_13" "CH_14" "CH_15" "CH_16" "CH_18" "CH_19" "CH_21" "CH_22" "CH_24"
#> substr(LM_WHOICD_KG_SORTED[,1][LM_WHOICD_KG_SORTED$word == 'depression'],1,5)
# [1] "CH_00" "CH_05" "CH_06" "CH_07" "CH_08" "CH_14" "CH_18" "CH_19" "CH_20" "CH_21" "CH_26"
 
 
state_data$STRESS_00[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][1]
state_data$STRESS_01[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][2]
state_data$STRESS_03[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][3]
state_data$STRESS_05[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][4]
state_data$STRESS_06[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][5]
state_data$STRESS_08[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][6]
state_data$STRESS_11[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][7]
state_data$STRESS_13[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][8]
state_data$STRESS_14[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][9]
state_data$STRESS_15[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][10]
state_data$STRESS_16[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][11]
state_data$STRESS_18[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][12]
state_data$STRESS_19[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][13]
state_data$STRESS_21[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][14]
state_data$STRESS_22[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][15]
state_data$STRESS_24[state_data$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][16]


state_data$DEPRESSION_00[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][1]
state_data$DEPRESSION_05[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][2]
state_data$DEPRESSION_06[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][3]
state_data$DEPRESSION_07[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][4]
state_data$DEPRESSION_08[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][5]
state_data$DEPRESSION_14[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][6]
state_data$DEPRESSION_18[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][7]
state_data$DEPRESSION_19[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][8]
state_data$DEPRESSION_20[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][9]
state_data$DEPRESSION_21[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][10]
state_data$DEPRESSION_26[state_data$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][11]


state_data$HEPB_00[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][1]
state_data$HEPB_01[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][2]
state_data$HEPB_02[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][3]
state_data$HEPB_03[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][4]
state_data$HEPB_13[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][5]
state_data$HEPB_14[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][6]
state_data$HEPB_18[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][7]
state_data$HEPB_19[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][8]
state_data$HEPB_22[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][9]
state_data$HEPB_24[state_data$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][10]

state_data$HEPC_00[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][1]
state_data$HEPC_01[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][2]
state_data$HEPC_02[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][3]
state_data$HEPC_03[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][4]
state_data$HEPC_13[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][5]
state_data$HEPC_14[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][6]
state_data$HEPC_18[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][7]
state_data$HEPC_19[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][8]
state_data$HEPC_22[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][9]
state_data$HEPC_24[state_data$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][10]

#> LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis']
# [1]  4 70  2  1 50  3  2  3  1  3

#state_data = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,STRESS_01,STRESS_02,STRESS_03,STRESS_04,STRESS_05,STRESS_06,STRESS_07,STRESS_08,STRESS_09,STRESS_10,STRESS_11,STRESS_12,STRESS_13,STRESS_14,STRESS_15,STRESS_16,STRESS_17,STRESS_18,STRESS_19,STRESS_20,STRESS_21,STRESS_22,STRESS_23,STRESS_24,STRESS_25,STRESS_26,DEPRESSION_01,DEPRESSION_02,DEPRESSION_03,DEPRESSION_04,DEPRESSION_05,DEPRESSION_06,DEPRESSION_07,DEPRESSION_08,DEPRESSION_09,DEPRESSION_10,DEPRESSION_11,DEPRESSION_12,DEPRESSION_13,DEPRESSION_14,DEPRESSION_15,DEPRESSION_16,DEPRESSION_17,DEPRESSION_18,DEPRESSION_19,DEPRESSION_20,DEPRESSION_21,DEPRESSION_22,DEPRESSION_23,DEPRESSION_24,DEPRESSION_25,DEPRESSION_26))
#
#state_data[is.na(state_data)] <- 0
#
#write.csv(state_data, "LLCP2021XPT_LINEAR_MENTAL.csv")


#> which( colnames(state_data)=="X_MICHD" )
#[1] 247

state_data$HEART_00[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][1]
state_data$HEART_01[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][2]
state_data$HEART_02[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][3]
state_data$HEART_03[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][4]
state_data$HEART_04[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][5]
state_data$HEART_05[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][6]
state_data$HEART_06[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][7]
state_data$HEART_07[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][8]
state_data$HEART_08[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][9]
state_data$HEART_09[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][10]
state_data$HEART_11[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][11]
state_data$HEART_12[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][12]
state_data$HEART_13[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][13]
state_data$HEART_17[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][14]
state_data$HEART_18[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][15]
state_data$HEART_19[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][16]
state_data$HEART_20[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][17]
state_data$HEART_21[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][18]
state_data$HEART_22[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][19]
state_data$HEART_24[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][20]
state_data$HEART_26[state_data$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][21]


#> LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer']
# [1]  1  3 39  2  2  6  3 10  3  1  2  5  2  7  3 36  1

state_data$MULTICANCER_00[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][1]
state_data$MULTICANCER_01[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][2]
state_data$MULTICANCER_02[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][3]
state_data$MULTICANCER_03[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][4]
state_data$MULTICANCER_04[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][5]
state_data$MULTICANCER_05[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][6]
state_data$MULTICANCER_06[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][7]
state_data$MULTICANCER_08[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][8]
state_data$MULTICANCER_09[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][9]
state_data$MULTICANCER_11[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][10]
state_data$MULTICANCER_13[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][11]
state_data$MULTICANCER_14[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][12]
state_data$MULTICANCER_15[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][13]
state_data$MULTICANCER_16[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][14]
state_data$MULTICANCER_20[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][15]
state_data$MULTICANCER_21[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][16]
state_data$MULTICANCER_24[state_data$CNCRDIFF == '102' | state_data$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][17]

multicancer = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,MULTICANCER_01,MULTICANCER_02,MULTICANCER_03,MULTICANCER_04,MULTICANCER_05,MULTICANCER_06,MULTICANCER_07,MULTICANCER_08,MULTICANCER_09,MULTICANCER_10,MULTICANCER_11,MULTICANCER_12,MULTICANCER_13,MULTICANCER_14,MULTICANCER_15,MULTICANCER_16,MULTICANCER_17,MULTICANCER_18,MULTICANCER_19,MULTICANCER_20,MULTICANCER_21,MULTICANCER_22,MULTICANCER_23,MULTICANCER_24,MULTICANCER_25,MULTICANCER_26))
...
#write.csv(state_data, "LLCP2021XPT_LINEAR_ML.csv")


heart = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,HEART_01,HEART_02,HEART_03,HEART_04,HEART_05,HEART_06,HEART_07,HEART_08,HEART_09,HEART_10,HEART_11,HEART_12,HEART_13,HEART_14,HEART_15,HEART_16,HEART_17,HEART_18,HEART_19,HEART_20,HEART_21,HEART_22,HEART_23,HEART_24,HEART_25,HEART_26))




smoke = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26))



gender = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26))

#write.csv(gender, "LLCP2021XPT_GENDER.csv")

gender_diabetes = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,LABEL_01,LABEL_02,LABEL_03,LABEL_04,LABEL_05,LABEL_06,LABEL_07,LABEL_08,LABEL_09,LABEL_10,LABEL_11,LABEL_12,LABEL_13,LABEL_14,LABEL_15,LABEL_16,LABEL_17,LABEL_18,LABEL_19,LABEL_20,LABEL_21,LABEL_22,LABEL_23,LABEL_24,LABEL_25,LABEL_26))

#write.csv(gender_diabetes, "LLCP2021XPT_GENDER_DIABETES.csv")

diabetes = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,LABEL_01,LABEL_02,LABEL_03,LABEL_04,LABEL_05,LABEL_06,LABEL_07,LABEL_08,LABEL_09,LABEL_10,LABEL_11,LABEL_12,LABEL_13,LABEL_14,LABEL_15,LABEL_16,LABEL_17,LABEL_18,LABEL_19,LABEL_20,LABEL_21,LABEL_22,LABEL_23,LABEL_24,LABEL_25,LABEL_26,PDTEST_01,PDTEST_02,PDTEST_03,PDTEST_04,PDTEST_05,PDTEST_06,PDTEST_07,PDTEST_08,PDTEST_09,PDTEST_10,PDTEST_11,PDTEST_12,PDTEST_13,PDTEST_14,PDTEST_15,PDTEST_16,PDTEST_17,PDTEST_18,PDTEST_19,PDTEST_20,PDTEST_21,PDTEST_22,PDTEST_23,PDTEST_24,PDTEST_25,PDTEST_26))



gender_weight = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,WEIGHT_01,WEIGHT_02,WEIGHT_03,WEIGHT_04,WEIGHT_05,WEIGHT_06,WEIGHT_07,WEIGHT_08,WEIGHT_09,WEIGHT_10,WEIGHT_11,WEIGHT_12,WEIGHT_13,WEIGHT_14,WEIGHT_15,WEIGHT_16,WEIGHT_17,WEIGHT_18,WEIGHT_19,WEIGHT_20,WEIGHT_21,WEIGHT_22,WEIGHT_23,WEIGHT_24,WEIGHT_25,WEIGHT_26))




gender_smoke = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26))

#write.csv(gender_smoke, "LLCP2021XPT_GENDER_SMOKE.csv")

gender_injury = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26))

#write.csv(gender_injury, "LLCP2021XPT_GENDER_INJURY.csv")

gender_fatigue = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

#write.csv(gender_fatigue, "LLCP2021XPT_GENDER_FATIGUE.csv")

gender_stress = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,STRESS_01,STRESS_02,STRESS_03,STRESS_04,STRESS_05,STRESS_06,STRESS_07,STRESS_08,STRESS_09,STRESS_10,STRESS_11,STRESS_12,STRESS_13,STRESS_14,STRESS_15,STRESS_16,STRESS_17,STRESS_18,STRESS_19,STRESS_20,STRESS_21,STRESS_22,STRESS_23,STRESS_24,STRESS_25,STRESS_26))



gender_depression = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,DEPRESSION_01,DEPRESSION_02,DEPRESSION_03,DEPRESSION_04,DEPRESSION_05,DEPRESSION_06,DEPRESSION_07,DEPRESSION_08,DEPRESSION_09,DEPRESSION_10,DEPRESSION_11,DEPRESSION_12,DEPRESSION_13,DEPRESSION_14,DEPRESSION_15,DEPRESSION_16,DEPRESSION_17,DEPRESSION_18,DEPRESSION_19,DEPRESSION_20,DEPRESSION_21,DEPRESSION_22,DEPRESSION_23,DEPRESSION_24,DEPRESSION_25,DEPRESSION_26))

#write.csv(gender_depression, "LLCP2021XPT_GENDER_DEPRESSION.csv")

gender_stress_depression = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,DEPRESSION_01,DEPRESSION_02,DEPRESSION_03,DEPRESSION_04,DEPRESSION_05,DEPRESSION_06,DEPRESSION_07,DEPRESSION_08,DEPRESSION_09,DEPRESSION_10,DEPRESSION_11,DEPRESSION_12,DEPRESSION_13,DEPRESSION_14,DEPRESSION_15,DEPRESSION_16,DEPRESSION_17,DEPRESSION_18,DEPRESSION_19,DEPRESSION_20,DEPRESSION_21,DEPRESSION_22,DEPRESSION_23,DEPRESSION_24,DEPRESSION_25,DEPRESSION_26,STRESS_01,STRESS_02,STRESS_03,STRESS_04,STRESS_05,STRESS_06,STRESS_07,STRESS_08,STRESS_09,STRESS_10,STRESS_11,STRESS_12,STRESS_13,STRESS_14,STRESS_15,STRESS_16,STRESS_17,STRESS_18,STRESS_19,STRESS_20,STRESS_21,STRESS_22,STRESS_23,STRESS_24,STRESS_25,STRESS_26,DEPRESSION_01,DEPRESSION_02,DEPRESSION_03,DEPRESSION_04,DEPRESSION_05,DEPRESSION_06,DEPRESSION_07,DEPRESSION_08,DEPRESSION_09,DEPRESSION_10,DEPRESSION_11,DEPRESSION_12,DEPRESSION_13,DEPRESSION_14,DEPRESSION_15,DEPRESSION_16,DEPRESSION_17,DEPRESSION_18,DEPRESSION_19,DEPRESSION_20,DEPRESSION_21,DEPRESSION_22,DEPRESSION_23,DEPRESSION_24,DEPRESSION_25,DEPRESSION_26))

#write.csv(gender_stress_depression, "LLCP2021XPT_GENDER_STRESS_DEPRESSION.csv")

gender_injury_fatigue = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))




injury_fatigue = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))



gender_weight_stress = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,WEIGHT_01,WEIGHT_02,WEIGHT_03,WEIGHT_04,WEIGHT_05,WEIGHT_06,WEIGHT_07,WEIGHT_08,WEIGHT_09,WEIGHT_10,WEIGHT_11,WEIGHT_12,WEIGHT_13,WEIGHT_14,WEIGHT_15,WEIGHT_16,WEIGHT_17,WEIGHT_18,WEIGHT_19,WEIGHT_20,WEIGHT_21,WEIGHT_22,WEIGHT_23,WEIGHT_24,WEIGHT_25,WEIGHT_26,STRESS_01,STRESS_02,STRESS_03,STRESS_04,STRESS_05,STRESS_06,STRESS_07,STRESS_08,STRESS_09,STRESS_10,STRESS_11,STRESS_12,STRESS_13,STRESS_14,STRESS_15,STRESS_16,STRESS_17,STRESS_18,STRESS_19,STRESS_20,STRESS_21,STRESS_22,STRESS_23,STRESS_24,STRESS_25,STRESS_26))




#write.csv(gender_weight_stress, "LLCP2021XPT_GENDER_WEIGHT_STRESS.csv")

gender_weight_stress_injury_fatigue = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,WEIGHT_01,WEIGHT_02,WEIGHT_03,WEIGHT_04,WEIGHT_05,WEIGHT_06,WEIGHT_07,WEIGHT_08,WEIGHT_09,WEIGHT_10,WEIGHT_11,WEIGHT_12,WEIGHT_13,WEIGHT_14,WEIGHT_15,WEIGHT_16,WEIGHT_17,WEIGHT_18,WEIGHT_19,WEIGHT_20,WEIGHT_21,WEIGHT_22,WEIGHT_23,WEIGHT_24,WEIGHT_25,WEIGHT_26,STRESS_01,STRESS_02,STRESS_03,STRESS_04,STRESS_05,STRESS_06,STRESS_07,STRESS_08,STRESS_09,STRESS_10,STRESS_11,STRESS_12,STRESS_13,STRESS_14,STRESS_15,STRESS_16,STRESS_17,STRESS_18,STRESS_19,STRESS_20,STRESS_21,STRESS_22,STRESS_23,STRESS_24,STRESS_25,STRESS_26,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

#write.csv(gender_weight_stress_injury_fatigue, "LLCP2021XPT_GENDER_WEIGHT_STRESS_INJURY_FATIGUE.csv")

gender_diabetes_injury_fatigue = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,LABEL_01,LABEL_02,LABEL_03,LABEL_04,LABEL_05,LABEL_06,LABEL_07,LABEL_08,LABEL_09,LABEL_10,LABEL_11,LABEL_12,LABEL_13,LABEL_14,LABEL_15,LABEL_16,LABEL_17,LABEL_18,LABEL_19,LABEL_20,LABEL_21,LABEL_22,LABEL_23,LABEL_24,LABEL_25,LABEL_26,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

#write.csv(gender_diabetes_injury_fatigue, "LLCP2021XPT_GENDER_DIABETES_INJURY_FATIGUE.csv")


alcohol = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,DRINK_01,DRINK_02,DRINK_03,DRINK_04,DRINK_05,DRINK_06,DRINK_07,DRINK_08,DRINK_09,DRINK_10,DRINK_11,DRINK_12,DRINK_13,DRINK_14,DRINK_15,DRINK_16,DRINK_17,DRINK_18,DRINK_19,DRINK_20,DRINK_21,DRINK_22,DRINK_23,DRINK_24,DRINK_25,DRINK_26))





gender_smoke_alcohol = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26,DRINK_01,DRINK_02,DRINK_03,DRINK_04,DRINK_05,DRINK_06,DRINK_07,DRINK_08,DRINK_09,DRINK_10,DRINK_11,DRINK_12,DRINK_13,DRINK_14,DRINK_15,DRINK_16,DRINK_17,DRINK_18,DRINK_19,DRINK_20,DRINK_21,DRINK_22,DRINK_23,DRINK_24,DRINK_25,DRINK_26))

#write.csv(gender_smoke_alcohol, "LLCP2021XPT_GENDER_SMOKE_ALCOHOL.csv")

smoke_alcohol = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26,DRINK_01,DRINK_02,DRINK_03,DRINK_04,DRINK_05,DRINK_06,DRINK_07,DRINK_08,DRINK_09,DRINK_10,DRINK_11,DRINK_12,DRINK_13,DRINK_14,DRINK_15,DRINK_16,DRINK_17,DRINK_18,DRINK_19,DRINK_20,DRINK_21,DRINK_22,DRINK_23,DRINK_24,DRINK_25,DRINK_26))

#write.csv(smoke_alcohol, "LLCP2021XPT_SMOKE_ALCOHOL.csv")


hepatitis = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,HEPB_01,HEPB_02,HEPB_03,HEPB_04,HEPB_05,HEPB_06,HEPB_07,HEPB_08,HEPB_09,HEPB_10,HEPB_11,HEPB_12,HEPB_13,HEPB_14,HEPB_15,HEPB_16,HEPB_17,HEPB_18,HEPB_19,HEPB_20,HEPB_21,HEPB_22,HEPB_23,HEPB_24,HEPB_25,HEPB_26,HEPC_01,HEPC_02,HEPC_03,HEPC_04,HEPC_05,HEPC_06,HEPC_07,HEPC_08,HEPC_09,HEPC_10,HEPC_11,HEPC_12,HEPC_13,HEPC_14,HEPC_15,HEPC_16,HEPC_17,HEPC_18,HEPC_19,HEPC_20,HEPC_21,HEPC_22,HEPC_23,HEPC_24,HEPC_25,HEPC_26))

#write.csv(hepatitis, "LLCP2021XPT_HEPATITIS.csv")

gender_hepatitis = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,HEPB_01,HEPB_02,HEPB_03,HEPB_04,HEPB_05,HEPB_06,HEPB_07,HEPB_08,HEPB_09,HEPB_10,HEPB_11,HEPB_12,HEPB_13,HEPB_14,HEPB_15,HEPB_16,HEPB_17,HEPB_18,HEPB_19,HEPB_20,HEPB_21,HEPB_22,HEPB_23,HEPB_24,HEPB_25,HEPB_26,HEPC_01,HEPC_02,HEPC_03,HEPC_04,HEPC_05,HEPC_06,HEPC_07,HEPC_08,HEPC_09,HEPC_10,HEPC_11,HEPC_12,HEPC_13,HEPC_14,HEPC_15,HEPC_16,HEPC_17,HEPC_18,HEPC_19,HEPC_20,HEPC_21,HEPC_22,HEPC_23,HEPC_24,HEPC_25,HEPC_26))
