...
#
#state_data$PAIN_00[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][1]
#state_data$PAIN_02[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][2]
#state_data$PAIN_05[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][3] 
#state_data$PAIN_06[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][4]
#state_data$PAIN_07[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][5] 
#state_data$PAIN_08[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][6]
#state_data$PAIN_11[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][7]
#state_data$PAIN_13[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][8] 
#state_data$PAIN_14[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][9]
#state_data$PAIN_17[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][10]
#state_data$PAIN_19[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][11] 
#state_data$PAIN_20[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][12]
#state_data$PAIN_21[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][13]
#state_data$PAIN_22[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][14] 
#state_data$PAIN_23[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][15]
#state_data$PAIN_24[state_data$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][16] 
#
...
state_data = subset(state_data, select = c(CNCRTYP1,CNCRDIFF,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,LABEL_01,LABEL_02,LABEL_03,LABEL_04,LABEL_05,LABEL_06,LABEL_07,LABEL_08,LABEL_09,LABEL_10,LABEL_11,LABEL_12,LABEL_13,LABEL_14,LABEL_15,LABEL_16,LABEL_17,LABEL_18,LABEL_19,LABEL_20,LABEL_21,LABEL_22,LABEL_23,LABEL_24,LABEL_25,LABEL_26,WEIGHT_01,WEIGHT_02,WEIGHT_03,WEIGHT_04,WEIGHT_05,WEIGHT_06,WEIGHT_07,WEIGHT_08,WEIGHT_09,WEIGHT_10,WEIGHT_11,WEIGHT_12,WEIGHT_13,WEIGHT_14,WEIGHT_15,WEIGHT_16,WEIGHT_17,WEIGHT_18,WEIGHT_19,WEIGHT_20,WEIGHT_21,WEIGHT_22,WEIGHT_23,WEIGHT_24,WEIGHT_25,WEIGHT_26,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26,PDTEST_01,PDTEST_02,PDTEST_03,PDTEST_04,PDTEST_05,PDTEST_06,PDTEST_07,PDTEST_08,PDTEST_09,PDTEST_10,PDTEST_11,PDTEST_12,PDTEST_13,PDTEST_14,PDTEST_15,PDTEST_16,PDTEST_17,PDTEST_18,PDTEST_19,PDTEST_20,PDTEST_21,PDTEST_22,PDTEST_23,PDTEST_24,PDTEST_25,PDTEST_26,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26,STRESS_01,STRESS_02,STRESS_03,STRESS_04,STRESS_05,STRESS_06,STRESS_07,STRESS_08,STRESS_09,STRESS_10,STRESS_11,STRESS_12,STRESS_13,STRESS_14,STRESS_15,STRESS_16,STRESS_17,STRESS_18,STRESS_19,STRESS_20,STRESS_21,STRESS_22,STRESS_23,STRESS_24,STRESS_25,STRESS_26,DEPRESSION_01,DEPRESSION_02,DEPRESSION_03,DEPRESSION_04,DEPRESSION_05,DEPRESSION_06,DEPRESSION_07,DEPRESSION_08,DEPRESSION_09,DEPRESSION_10,DEPRESSION_11,DEPRESSION_12,DEPRESSION_13,DEPRESSION_14,DEPRESSION_15,DEPRESSION_16,DEPRESSION_17,DEPRESSION_18,DEPRESSION_19,DEPRESSION_20,DEPRESSION_21,DEPRESSION_22,DEPRESSION_23,DEPRESSION_24,DEPRESSION_25,DEPRESSION_26))
