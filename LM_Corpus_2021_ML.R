...
#state_data['PAIN_00'] <- 0
#state_data['PAIN_01'] <- 0
#state_data['PAIN_02'] <- 0
#state_data['PAIN_03'] <- 0
#state_data['PAIN_04'] <- 0                                  
#state_data['PAIN_05'] <- 0
#state_data['PAIN_06'] <- 0
#state_data['PAIN_07'] <- 0
#state_data['PAIN_08'] <- 0
#state_data['PAIN_09'] <- 0
#state_data['PAIN_10'] <- 0
#state_data['PAIN_11'] <- 0
#state_data['PAIN_12'] <- 0
#state_data['PAIN_13'] <- 0
#state_data['PAIN_14'] <- 0
#state_data['PAIN_15'] <- 0
#state_data['PAIN_16'] <- 0
#state_data['PAIN_17'] <- 0
#state_data['PAIN_18'] <- 0
#state_data['PAIN_19'] <- 0
#state_data['PAIN_20'] <- 0
#state_data['PAIN_21'] <- 0
#state_data['PAIN_22'] <- 0
#state_data['PAIN_23'] <- 0
#state_data['PAIN_24'] <- 0
#state_data['PAIN_25'] <- 0
#state_data['PAIN_26'] <- 0
...
#write.csv(state_data, "LLCP2021XPT_LINEAR_SYMPTOMS.csv")
