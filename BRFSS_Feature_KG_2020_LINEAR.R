...
state_data2020 <- subset(data, X_STATE == 4 | X_STATE == 9 | X_STATE == 10 | X_STATE == 13 | X_STATE == 15 | X_STATE == 18 | X_STATE == 22 | X_STATE == 25 | X_STATE == 26 | X_STATE == 28 | X_STATE == 29 | X_STATE == 30 | X_STATE == 34 | X_STATE == 35 | X_STATE == 37 | X_STATE == 44 | X_STATE == 46 | X_STATE == 49 | X_STATE == 50 | X_STATE == 51 | X_STATE == 55 | X_STATE == 56 | X_STATE == 66 | X_STATE == 31 | X_STATE == 16 | X_STATE == 19 | X_STATE == 2 | X_STATE == 31 | X_STATE == 1 | X_STATE == 40 | X_STATE == 39) 

state_data2020[167][is.na(state_data2020[167])] <- '0'
state_data2020[167][state_data2020[167] == 1] <- '1'
state_data2020[167][state_data2020[167] == 2] <- '2'
state_data2020[167][state_data2020[167] == 3] <- '3'
state_data2020[167][state_data2020[167] == 4] <- '4'
state_data2020[167][state_data2020[167] == 5] <- '5'
state_data2020[167][state_data2020[167] == 6] <- '6'
state_data2020[167][state_data2020[167] == 7] <- '7'
state_data2020[167][state_data2020[167] == 8] <- '8'
state_data2020[167][state_data2020[167] == 9] <- '9'
state_data2020[167][state_data2020[167] == 10] <- '10'
state_data2020[167][state_data2020[167] == 11] <- '11'
state_data2020[167][state_data2020[167] == 12] <- '12'
state_data2020[167][state_data2020[167] == 13] <- '13'
state_data2020[167][state_data2020[167] == 14] <- '14'
state_data2020[167][state_data2020[167] == 15] <- '15'
state_data2020[167][state_data2020[167] == 16] <- '16'
state_data2020[167][state_data2020[167] == 17] <- '17'
state_data2020[167][state_data2020[167] == 18] <- '18'
state_data2020[167][state_data2020[167] == 19] <- '19'
state_data2020[167][state_data2020[167] == 20] <- '20'
state_data2020[167][state_data2020[167] == 21] <- '21'
state_data2020[167][state_data2020[167] == 22] <- '22'
state_data2020[167][state_data2020[167] == 23] <- '23'
state_data2020[167][state_data2020[167] == 24] <- '24'
state_data2020[167][state_data2020[167] == 25] <- '25'
state_data2020[167][state_data2020[167] == 26] <- '26'
state_data2020[167][state_data2020[167] == 27] <- '27'
state_data2020[167][state_data2020[167] == 28] <- '28'
state_data2020[167][state_data2020[167] == 29] <- '29'
state_data2020[167][state_data2020[167] == 30] <- '30'
state_data2020[167][state_data2020[167] == 77] <- '77'
state_data2020[167][state_data2020[167] == 99] <- '99'

state_data2020[165][is.na(state_data2020[165])] <- '0'
state_data2020[165][state_data2020[165] == 1] <- '101'
state_data2020[165][state_data2020[165] == 2] <- '102'
state_data2020[165][state_data2020[165] == 3] <- '103'
state_data2020[165][state_data2020[165] == 7] <- '107'
state_data2020[165][state_data2020[165] == 9] <- '109'

state_data[167][(state_data[165] %in% c('101', '102', '103')) & (state_data[167] %in% c('0'))] <- '99'
state_data[165][(state_data[165] %in% c('101', '102', '103')) & (state_data[167] %in% c('0'))] <- '99'

LM_WHOICD_KG <- subset(LM_Chapter_Scores,select=c('chapter','word','n'))

state_data2020['GENDER_00'] <- 0
state_data2020['GENDER_01'] <- 0
state_data2020['GENDER_02'] <- 0
state_data2020['GENDER_03'] <- 0
state_data2020['GENDER_04'] <- 0                                  
state_data2020['GENDER_05'] <- 0
state_data2020['GENDER_06'] <- 0
state_data2020['GENDER_07'] <- 0
state_data2020['GENDER_08'] <- 0
state_data2020['GENDER_09'] <- 0
state_data2020['GENDER_10'] <- 0
state_data2020['GENDER_11'] <- 0
state_data2020['GENDER_12'] <- 0
state_data2020['GENDER_13'] <- 0
state_data2020['GENDER_14'] <- 0
state_data2020['GENDER_15'] <- 0
state_data2020['GENDER_16'] <- 0
state_data2020['GENDER_17'] <- 0
state_data2020['GENDER_18'] <- 0
state_data2020['GENDER_19'] <- 0
state_data2020['GENDER_20'] <- 0
state_data2020['GENDER_21'] <- 0
state_data2020['GENDER_22'] <- 0
state_data2020['GENDER_23'] <- 0
state_data2020['GENDER_24'] <- 0
state_data2020['GENDER_25'] <- 0
state_data2020['GENDER_26'] <- 0
 

state_data2020['LABEL_00'] <- 0
state_data2020['LABEL_01'] <- 0
state_data2020['LABEL_02'] <- 0
state_data2020['LABEL_03'] <- 0
state_data2020['LABEL_04'] <- 0                                  
state_data2020['LABEL_05'] <- 0
state_data2020['LABEL_06'] <- 0
state_data2020['LABEL_07'] <- 0
state_data2020['LABEL_08'] <- 0
state_data2020['LABEL_09'] <- 0
state_data2020['LABEL_10'] <- 0
state_data2020['LABEL_11'] <- 0
state_data2020['LABEL_12'] <- 0
state_data2020['LABEL_13'] <- 0
state_data2020['LABEL_14'] <- 0
state_data2020['LABEL_15'] <- 0
state_data2020['LABEL_16'] <- 0
state_data2020['LABEL_17'] <- 0
state_data2020['LABEL_18'] <- 0
state_data2020['LABEL_19'] <- 0
state_data2020['LABEL_20'] <- 0
state_data2020['LABEL_21'] <- 0
state_data2020['LABEL_22'] <- 0
state_data2020['LABEL_23'] <- 0
state_data2020['LABEL_24'] <- 0
state_data2020['LABEL_25'] <- 0
state_data2020['LABEL_26'] <- 0

state_data2020['WEIGHT_00'] <- 0
state_data2020['WEIGHT_01'] <- 0
state_data2020['WEIGHT_02'] <- 0
state_data2020['WEIGHT_03'] <- 0
state_data2020['WEIGHT_04'] <- 0                                  
state_data2020['WEIGHT_05'] <- 0
state_data2020['WEIGHT_06'] <- 0
state_data2020['WEIGHT_07'] <- 0
state_data2020['WEIGHT_08'] <- 0
state_data2020['WEIGHT_09'] <- 0
state_data2020['WEIGHT_10'] <- 0
state_data2020['WEIGHT_11'] <- 0
state_data2020['WEIGHT_12'] <- 0
state_data2020['WEIGHT_13'] <- 0
state_data2020['WEIGHT_14'] <- 0
state_data2020['WEIGHT_15'] <- 0
state_data2020['WEIGHT_16'] <- 0
state_data2020['WEIGHT_17'] <- 0
state_data2020['WEIGHT_18'] <- 0
state_data2020['WEIGHT_19'] <- 0
state_data2020['WEIGHT_20'] <- 0
state_data2020['WEIGHT_21'] <- 0
state_data2020['WEIGHT_22'] <- 0
state_data2020['WEIGHT_23'] <- 0
state_data2020['WEIGHT_24'] <- 0
state_data2020['WEIGHT_25'] <- 0
state_data2020['WEIGHT_26'] <- 0

state_data2020['SMOKE_00'] <- 0
state_data2020['SMOKE_01'] <- 0
state_data2020['SMOKE_02'] <- 0
state_data2020['SMOKE_03'] <- 0
state_data2020['SMOKE_04'] <- 0                                  
state_data2020['SMOKE_05'] <- 0
state_data2020['SMOKE_06'] <- 0
state_data2020['SMOKE_07'] <- 0
state_data2020['SMOKE_08'] <- 0
state_data2020['SMOKE_09'] <- 0
state_data2020['SMOKE_10'] <- 0
state_data2020['SMOKE_11'] <- 0
state_data2020['SMOKE_12'] <- 0
state_data2020['SMOKE_13'] <- 0
state_data2020['SMOKE_14'] <- 0
state_data2020['SMOKE_15'] <- 0
state_data2020['SMOKE_16'] <- 0
state_data2020['SMOKE_17'] <- 0
state_data2020['SMOKE_18'] <- 0
state_data2020['SMOKE_19'] <- 0
state_data2020['SMOKE_20'] <- 0
state_data2020['SMOKE_21'] <- 0
state_data2020['SMOKE_22'] <- 0
state_data2020['SMOKE_23'] <- 0
state_data2020['SMOKE_24'] <- 0
state_data2020['SMOKE_25'] <- 0
state_data2020['SMOKE_26'] <- 0
 

state_data2020['PDTEST_00'] <- 0
state_data2020['PDTEST_01'] <- 0
state_data2020['PDTEST_02'] <- 0
state_data2020['PDTEST_03'] <- 0
state_data2020['PDTEST_04'] <- 0                                  
state_data2020['PDTEST_05'] <- 0
state_data2020['PDTEST_06'] <- 0
state_data2020['PDTEST_07'] <- 0
state_data2020['PDTEST_08'] <- 0
state_data2020['PDTEST_09'] <- 0
state_data2020['PDTEST_10'] <- 0
state_data2020['PDTEST_11'] <- 0
state_data2020['PDTEST_12'] <- 0
state_data2020['PDTEST_13'] <- 0
state_data2020['PDTEST_14'] <- 0
state_data2020['PDTEST_15'] <- 0
state_data2020['PDTEST_16'] <- 0
state_data2020['PDTEST_17'] <- 0
state_data2020['PDTEST_18'] <- 0
state_data2020['PDTEST_19'] <- 0
state_data2020['PDTEST_20'] <- 0
state_data2020['PDTEST_21'] <- 0
state_data2020['PDTEST_22'] <- 0
state_data2020['PDTEST_23'] <- 0
state_data2020['PDTEST_24'] <- 0
state_data2020['PDTEST_25'] <- 0
state_data2020['PDTEST_26'] <- 0

state_data2020['INJURY_00'] <- 0
state_data2020['INJURY_01'] <- 0
state_data2020['INJURY_02'] <- 0
state_data2020['INJURY_03'] <- 0
state_data2020['INJURY_04'] <- 0                                  
state_data2020['INJURY_05'] <- 0
state_data2020['INJURY_06'] <- 0
state_data2020['INJURY_07'] <- 0
state_data2020['INJURY_08'] <- 0
state_data2020['INJURY_09'] <- 0
state_data2020['INJURY_10'] <- 0
state_data2020['INJURY_11'] <- 0
state_data2020['INJURY_12'] <- 0
state_data2020['INJURY_13'] <- 0
state_data2020['INJURY_14'] <- 0
state_data2020['INJURY_15'] <- 0
state_data2020['INJURY_16'] <- 0
state_data2020['INJURY_17'] <- 0
state_data2020['INJURY_18'] <- 0
state_data2020['INJURY_19'] <- 0
state_data2020['INJURY_20'] <- 0
state_data2020['INJURY_21'] <- 0
state_data2020['INJURY_22'] <- 0
state_data2020['INJURY_23'] <- 0
state_data2020['INJURY_24'] <- 0
state_data2020['INJURY_25'] <- 0
state_data2020['INJURY_26'] <- 0

state_data2020['FATIGUE_00'] <- 0
state_data2020['FATIGUE_01'] <- 0
state_data2020['FATIGUE_02'] <- 0
state_data2020['FATIGUE_03'] <- 0
state_data2020['FATIGUE_04'] <- 0                                  
state_data2020['FATIGUE_05'] <- 0
state_data2020['FATIGUE_06'] <- 0
state_data2020['FATIGUE_07'] <- 0
state_data2020['FATIGUE_08'] <- 0
state_data2020['FATIGUE_09'] <- 0
state_data2020['FATIGUE_10'] <- 0
state_data2020['FATIGUE_11'] <- 0
state_data2020['FATIGUE_12'] <- 0
state_data2020['FATIGUE_13'] <- 0
state_data2020['FATIGUE_14'] <- 0
state_data2020['FATIGUE_15'] <- 0
state_data2020['FATIGUE_16'] <- 0
state_data2020['FATIGUE_17'] <- 0
state_data2020['FATIGUE_18'] <- 0
state_data2020['FATIGUE_19'] <- 0
state_data2020['FATIGUE_20'] <- 0
state_data2020['FATIGUE_21'] <- 0
state_data2020['FATIGUE_22'] <- 0
state_data2020['FATIGUE_23'] <- 0
state_data2020['FATIGUE_24'] <- 0
state_data2020['FATIGUE_25'] <- 0
state_data2020['FATIGUE_26'] <- 0

state_data2020['STRESS_00'] <- 0
state_data2020['STRESS_01'] <- 0
state_data2020['STRESS_02'] <- 0
state_data2020['STRESS_03'] <- 0
state_data2020['STRESS_04'] <- 0                                  
state_data2020['STRESS_05'] <- 0
state_data2020['STRESS_06'] <- 0
state_data2020['STRESS_07'] <- 0
state_data2020['STRESS_08'] <- 0
state_data2020['STRESS_09'] <- 0
state_data2020['STRESS_10'] <- 0
state_data2020['STRESS_11'] <- 0
state_data2020['STRESS_12'] <- 0
state_data2020['STRESS_13'] <- 0
state_data2020['STRESS_14'] <- 0
state_data2020['STRESS_15'] <- 0
state_data2020['STRESS_16'] <- 0
state_data2020['STRESS_17'] <- 0
state_data2020['STRESS_18'] <- 0
state_data2020['STRESS_19'] <- 0
state_data2020['STRESS_20'] <- 0
state_data2020['STRESS_21'] <- 0
state_data2020['STRESS_22'] <- 0
state_data2020['STRESS_23'] <- 0
state_data2020['STRESS_24'] <- 0
state_data2020['STRESS_25'] <- 0
state_data2020['STRESS_26'] <- 0

state_data2020['DEPRESSION_00'] <- 0
state_data2020['DEPRESSION_01'] <- 0
state_data2020['DEPRESSION_02'] <- 0
state_data2020['DEPRESSION_03'] <- 0
state_data2020['DEPRESSION_04'] <- 0                                  
state_data2020['DEPRESSION_05'] <- 0
state_data2020['DEPRESSION_06'] <- 0
state_data2020['DEPRESSION_07'] <- 0
state_data2020['DEPRESSION_08'] <- 0
state_data2020['DEPRESSION_09'] <- 0
state_data2020['DEPRESSION_10'] <- 0
state_data2020['DEPRESSION_11'] <- 0
state_data2020['DEPRESSION_12'] <- 0
state_data2020['DEPRESSION_13'] <- 0
state_data2020['DEPRESSION_14'] <- 0
state_data2020['DEPRESSION_15'] <- 0
state_data2020['DEPRESSION_16'] <- 0
state_data2020['DEPRESSION_17'] <- 0
state_data2020['DEPRESSION_18'] <- 0
state_data2020['DEPRESSION_19'] <- 0
state_data2020['DEPRESSION_20'] <- 0
state_data2020['DEPRESSION_21'] <- 0
state_data2020['DEPRESSION_22'] <- 0
state_data2020['DEPRESSION_23'] <- 0
state_data2020['DEPRESSION_24'] <- 0
state_data2020['DEPRESSION_25'] <- 0
state_data2020['DEPRESSION_26'] <- 0
 

state_data2020['ASTHMA_00'] <- 0
state_data2020['ASTHMA_01'] <- 0
state_data2020['ASTHMA_02'] <- 0
state_data2020['ASTHMA_03'] <- 0
state_data2020['ASTHMA_04'] <- 0                                  
state_data2020['ASTHMA_05'] <- 0
state_data2020['ASTHMA_06'] <- 0
state_data2020['ASTHMA_07'] <- 0
state_data2020['ASTHMA_08'] <- 0
state_data2020['ASTHMA_09'] <- 0
state_data2020['ASTHMA_10'] <- 0
state_data2020['ASTHMA_11'] <- 0
state_data2020['ASTHMA_12'] <- 0
state_data2020['ASTHMA_13'] <- 0
state_data2020['ASTHMA_14'] <- 0
state_data2020['ASTHMA_15'] <- 0
state_data2020['ASTHMA_16'] <- 0
state_data2020['ASTHMA_17'] <- 0
state_data2020['ASTHMA_18'] <- 0
state_data2020['ASTHMA_19'] <- 0
state_data2020['ASTHMA_20'] <- 0
state_data2020['ASTHMA_21'] <- 0
state_data2020['ASTHMA_22'] <- 0
state_data2020['ASTHMA_23'] <- 0
state_data2020['ASTHMA_24'] <- 0
state_data2020['ASTHMA_25'] <- 0
state_data2020['ASTHMA_26'] <- 0
 
 
state_data2020['DRINK_00'] <- 0
state_data2020['DRINK_01'] <- 0
state_data2020['DRINK_02'] <- 0
state_data2020['DRINK_03'] <- 0
state_data2020['DRINK_04'] <- 0                                  
state_data2020['DRINK_05'] <- 0
state_data2020['DRINK_06'] <- 0
state_data2020['DRINK_07'] <- 0
state_data2020['DRINK_08'] <- 0
state_data2020['DRINK_09'] <- 0
state_data2020['DRINK_10'] <- 0
state_data2020['DRINK_11'] <- 0
state_data2020['DRINK_12'] <- 0
state_data2020['DRINK_13'] <- 0
state_data2020['DRINK_14'] <- 0
state_data2020['DRINK_15'] <- 0
state_data2020['DRINK_16'] <- 0
state_data2020['DRINK_17'] <- 0
state_data2020['DRINK_18'] <- 0
state_data2020['DRINK_19'] <- 0
state_data2020['DRINK_20'] <- 0
state_data2020['DRINK_21'] <- 0
state_data2020['DRINK_22'] <- 0
state_data2020['DRINK_23'] <- 0
state_data2020['DRINK_24'] <- 0
state_data2020['DRINK_25'] <- 0
state_data2020['DRINK_26'] <- 0



state_data2020['HEPC_00'] <- 0
state_data2020['HEPC_01'] <- 0
state_data2020['HEPC_02'] <- 0
state_data2020['HEPC_03'] <- 0
state_data2020['HEPC_04'] <- 0                                  
state_data2020['HEPC_05'] <- 0
state_data2020['HEPC_06'] <- 0
state_data2020['HEPC_07'] <- 0
state_data2020['HEPC_08'] <- 0
state_data2020['HEPC_09'] <- 0
state_data2020['HEPC_10'] <- 0
state_data2020['HEPC_11'] <- 0
state_data2020['HEPC_12'] <- 0
state_data2020['HEPC_13'] <- 0
state_data2020['HEPC_14'] <- 0
state_data2020['HEPC_15'] <- 0
state_data2020['HEPC_16'] <- 0
state_data2020['HEPC_17'] <- 0
state_data2020['HEPC_18'] <- 0
state_data2020['HEPC_19'] <- 0
state_data2020['HEPC_20'] <- 0
state_data2020['HEPC_21'] <- 0
state_data2020['HEPC_22'] <- 0
state_data2020['HEPC_23'] <- 0
state_data2020['HEPC_24'] <- 0
state_data2020['HEPC_25'] <- 0
state_data2020['HEPC_26'] <- 0

# TOLDHEPC 

state_data2020['HEPB_00'] <- 0
state_data2020['HEPB_01'] <- 0
state_data2020['HEPB_02'] <- 0
state_data2020['HEPB_03'] <- 0
state_data2020['HEPB_04'] <- 0                                  
state_data2020['HEPB_05'] <- 0
state_data2020['HEPB_06'] <- 0
state_data2020['HEPB_07'] <- 0
state_data2020['HEPB_08'] <- 0
state_data2020['HEPB_09'] <- 0
state_data2020['HEPB_10'] <- 0
state_data2020['HEPB_11'] <- 0
state_data2020['HEPB_12'] <- 0
state_data2020['HEPB_13'] <- 0
state_data2020['HEPB_14'] <- 0
state_data2020['HEPB_15'] <- 0
state_data2020['HEPB_16'] <- 0
state_data2020['HEPB_17'] <- 0
state_data2020['HEPB_18'] <- 0
state_data2020['HEPB_19'] <- 0
state_data2020['HEPB_20'] <- 0
state_data2020['HEPB_21'] <- 0
state_data2020['HEPB_22'] <- 0
state_data2020['HEPB_23'] <- 0
state_data2020['HEPB_24'] <- 0
state_data2020['HEPB_25'] <- 0
state_data2020['HEPB_26'] <- 0

# HAVEHEPB

state_data2020['HEART_00'] <- 0
state_data2020['HEART_01'] <- 0
state_data2020['HEART_02'] <- 0
state_data2020['HEART_03'] <- 0
state_data2020['HEART_04'] <- 0                                  
state_data2020['HEART_05'] <- 0
state_data2020['HEART_06'] <- 0
state_data2020['HEART_07'] <- 0
state_data2020['HEART_08'] <- 0
state_data2020['HEART_09'] <- 0
state_data2020['HEART_10'] <- 0
state_data2020['HEART_11'] <- 0
state_data2020['HEART_12'] <- 0
state_data2020['HEART_13'] <- 0
state_data2020['HEART_14'] <- 0
state_data2020['HEART_15'] <- 0
state_data2020['HEART_16'] <- 0
state_data2020['HEART_17'] <- 0
state_data2020['HEART_18'] <- 0
state_data2020['HEART_19'] <- 0
state_data2020['HEART_20'] <- 0
state_data2020['HEART_21'] <- 0
state_data2020['HEART_22'] <- 0
state_data2020['HEART_23'] <- 0
state_data2020['HEART_24'] <- 0
state_data2020['HEART_25'] <- 0
state_data2020['HEART_26'] <- 0


state_data2020['AGE65UP_00'] <- 0
state_data2020['AGE65UP_01'] <- 0
state_data2020['AGE65UP_02'] <- 0
state_data2020['AGE65UP_03'] <- 0
state_data2020['AGE65UP_04'] <- 0                                  
state_data2020['AGE65UP_05'] <- 0
state_data2020['AGE65UP_06'] <- 0
state_data2020['AGE65UP_07'] <- 0
state_data2020['AGE65UP_08'] <- 0
state_data2020['AGE65UP_09'] <- 0
state_data2020['AGE65UP_10'] <- 0
state_data2020['AGE65UP_11'] <- 0
state_data2020['AGE65UP_12'] <- 0
state_data2020['AGE65UP_13'] <- 0
state_data2020['AGE65UP_14'] <- 0
state_data2020['AGE65UP_15'] <- 0
state_data2020['AGE65UP_16'] <- 0
state_data2020['AGE65UP_17'] <- 0
state_data2020['AGE65UP_18'] <- 0
state_data2020['AGE65UP_19'] <- 0
state_data2020['AGE65UP_20'] <- 0
state_data2020['AGE65UP_21'] <- 0
state_data2020['AGE65UP_22'] <- 0
state_data2020['AGE65UP_23'] <- 0
state_data2020['AGE65UP_24'] <- 0
state_data2020['AGE65UP_25'] <- 0
state_data2020['AGE65UP_26'] <- 0

state_data2020['MULTICANCER_00'] <- 0
state_data2020['MULTICANCER_01'] <- 0
state_data2020['MULTICANCER_02'] <- 0
state_data2020['MULTICANCER_03'] <- 0
state_data2020['MULTICANCER_04'] <- 0                                  
state_data2020['MULTICANCER_05'] <- 0
state_data2020['MULTICANCER_06'] <- 0
state_data2020['MULTICANCER_07'] <- 0
state_data2020['MULTICANCER_08'] <- 0
state_data2020['MULTICANCER_09'] <- 0
state_data2020['MULTICANCER_10'] <- 0
state_data2020['MULTICANCER_11'] <- 0
state_data2020['MULTICANCER_12'] <- 0
state_data2020['MULTICANCER_13'] <- 0
state_data2020['MULTICANCER_14'] <- 0
state_data2020['MULTICANCER_15'] <- 0
state_data2020['MULTICANCER_16'] <- 0
state_data2020['MULTICANCER_17'] <- 0
state_data2020['MULTICANCER_18'] <- 0
state_data2020['MULTICANCER_19'] <- 0
state_data2020['MULTICANCER_20'] <- 0
state_data2020['MULTICANCER_21'] <- 0
state_data2020['MULTICANCER_22'] <- 0
state_data2020['MULTICANCER_23'] <- 0
state_data2020['MULTICANCER_24'] <- 0
state_data2020['MULTICANCER_25'] <- 0
state_data2020['MULTICANCER_26'] <- 0
...
state_data2020[is.na(state_data2020)] <- 0


state_data2020$GENDER_00[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][1]
state_data2020$GENDER_02[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][2]
state_data2020$GENDER_04[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][3] 
state_data2020$GENDER_05[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][4]
state_data2020$GENDER_08[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][5] 
state_data2020$GENDER_11[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][6]
state_data2020$GENDER_14[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][7]
state_data2020$GENDER_16[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][8] 
state_data2020$GENDER_17[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][9]
state_data2020$GENDER_20[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][10]
state_data2020$GENDER_21[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][11] 
state_data2020$GENDER_22[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][12]
state_data2020$GENDER_24[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][13]
state_data2020$GENDER_26[state_data2020$X_SEX == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'male'][14] 
...
state_data2020$GENDER_00[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][1]
state_data2020$GENDER_01[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][2]
state_data2020$GENDER_02[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][3]
state_data2020$GENDER_04[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][4]
state_data2020$GENDER_05[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][5]
state_data2020$GENDER_13[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][6]
state_data2020$GENDER_14[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][7]
state_data2020$GENDER_15[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][8]
state_data2020$GENDER_16[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][9]
state_data2020$GENDER_17[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][10]
state_data2020$GENDER_18[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][11]
state_data2020$GENDER_20[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][12]
state_data2020$GENDER_21[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][13]
state_data2020$GENDER_22[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][14]
state_data2020$GENDER_24[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][15]
state_data2020$GENDER_26[state_data2020$X_SEX == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'female'][16]


state_data2020["DIABETE4"][is.na(state_data2020["DIABETE4"])] <- 9

state_data2020$LABEL_00[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][1]
state_data2020$LABEL_01[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][2]
state_data2020$LABEL_05[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][3]
state_data2020$LABEL_06[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][4]
state_data2020$LABEL_07[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][5]
state_data2020$LABEL_08[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][6]
state_data2020$LABEL_09[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][7]
state_data2020$LABEL_10[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][8]
state_data2020$LABEL_11[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][9]
state_data2020$LABEL_12[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][10]
state_data2020$LABEL_14[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][11]
state_data2020$LABEL_15[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][12]
state_data2020$LABEL_16[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][13]
state_data2020$LABEL_18[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][14]
state_data2020$LABEL_19[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][15]
state_data2020$LABEL_20[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][16]
state_data2020$LABEL_21[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][17]
state_data2020$LABEL_24[state_data2020$DIABETE4 == 1 | state_data2020$DIABETE4 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'diabetes'][18]

state_data2020["PDIABTST"][is.na(state_data2020["PDIABTST"])] <- 7

state_data2020$PDTEST_05[state_data2020$PDIABTST == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'sugar'][1]
state_data2020$PDTEST_09[state_data2020$PDIABTST == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'sugar'][2]
state_data2020$PDTEST_12[state_data2020$PDIABTST == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'sugar'][3]
state_data2020$PDTEST_21[state_data2020$PDIABTST == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'sugar'][4]

state_data2020["X_BMI5CAT"][is.na(state_data2020["X_BMI5CAT"])] <- 5


state_data2020$WEIGHT_09[state_data2020$X_BMI5CAT == 4] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'obese'][1]
state_data2020$WEIGHT_14[state_data2020$X_BMI5CAT == 4] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'obese'][2]
state_data2020$WEIGHT_21[state_data2020$X_BMI5CAT == 4] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'obese'][3]


state_data2020$WEIGHT_00[state_data2020$X_BMI5CAT == 4] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'overweight'][1]
state_data2020$WEIGHT_05[state_data2020$X_BMI5CAT == 4] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'overweight'][2]
state_data2020$WEIGHT_08[state_data2020$X_BMI5CAT == 4] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'overweight'][3]
state_data2020$WEIGHT_19[state_data2020$X_BMI5CAT == 4] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'overweight'][4]


state_data2020["SMOKDAY2"][is.na(state_data2020["SMOKDAY2"])] <- 7


state_data2020$SMOKE_06[state_data2020$SMOKDAY2 == 1 | state_data2020$SMOKDAY2 == 2] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'smoked' | LM_WHOICD_KG_SORTED$word == 'cigarettes' | LM_WHOICD_KG_SORTED$word == 'tabacco'][1] + LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'smoked' | LM_WHOICD_KG_SORTED$word == 'cigarettes' | LM_WHOICD_KG_SORTED$word == 'tabacco'][2]


state_data2020$DRINK_00[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][1]
state_data2020$DRINK_02[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][2]
state_data2020$DRINK_05[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][3] 
state_data2020$DRINK_06[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][4]
state_data2020$DRINK_07[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][5] 
state_data2020$DRINK_08[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][6]
state_data2020$DRINK_11[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][7]
state_data2020$DRINK_13[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][8] 
state_data2020$DRINK_14[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][9]
state_data2020$DRINK_17[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][10]
state_data2020$DRINK_19[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][11] 
state_data2020$DRINK_20[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][12]
state_data2020$DRINK_21[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][13]
state_data2020$DRINK_22[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][14] 
state_data2020$DRINK_23[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][15]
state_data2020$DRINK_24[state_data2020$DRNK3GE5 < 77] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'alcohol'][16]


state_data2020$INJURY_00[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][1]
state_data2020$INJURY_01[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][2]
state_data2020$INJURY_03[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][3] 
state_data2020$INJURY_05[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][4]
state_data2020$INJURY_06[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][5] 
state_data2020$INJURY_07[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][6]
state_data2020$INJURY_08[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][7]
state_data2020$INJURY_09[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][8] 
state_data2020$INJURY_10[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][9]
state_data2020$INJURY_11[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][10]
state_data2020$INJURY_12[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][11] 
state_data2020$INJURY_13[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][12]
state_data2020$INJURY_14[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][13]
state_data2020$INJURY_15[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][14] 
state_data2020$INJURY_16[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][15]
state_data2020$INJURY_18[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][16] 
state_data2020$INJURY_19[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][17]
state_data2020$INJURY_20[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][18]
state_data2020$INJURY_22[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][19] 
state_data2020$INJURY_23[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][20]
state_data2020$INJURY_24[state_data2020$PHYSHLTH < 31] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'injury'][21]


state_data2020$FATIGUE_00[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][1]
state_data2020$FATIGUE_01[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][2]
state_data2020$FATIGUE_03[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][3]
state_data2020$FATIGUE_04[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][4]
state_data2020$FATIGUE_05[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][5]
state_data2020$FATIGUE_06[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][6]
state_data2020$FATIGUE_07[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][7]
state_data2020$FATIGUE_08[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][8]
state_data2020$FATIGUE_11[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][9]
state_data2020$FATIGUE_12[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][10]
state_data2020$FATIGUE_13[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][11]
state_data2020$FATIGUE_15[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][12]
state_data2020$FATIGUE_16[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][13]
state_data2020$FATIGUE_19[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][14]
state_data2020$FATIGUE_21[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][15]
state_data2020$FATIGUE_22[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][16]
state_data2020$FATIGUE_26[state_data2020$TOLDCFS == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'fatigue'][17]


state_data2020$STRESS_00[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][1]
state_data2020$STRESS_01[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][2]
state_data2020$STRESS_03[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][3]
state_data2020$STRESS_05[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][4]
state_data2020$STRESS_06[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][5]
state_data2020$STRESS_08[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][6]
state_data2020$STRESS_11[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][7]
state_data2020$STRESS_13[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][8]
state_data2020$STRESS_14[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][9]
state_data2020$STRESS_15[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][10]
state_data2020$STRESS_16[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][11]
state_data2020$STRESS_18[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][12]
state_data2020$STRESS_19[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][13]
state_data2020$STRESS_21[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][14]
state_data2020$STRESS_22[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][15]
state_data2020$STRESS_24[state_data2020$MENTHLTH <= 30] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'stress'][16]

state_data2020$DEPRESSION_00[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][1]
state_data2020$DEPRESSION_05[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][2]
state_data2020$DEPRESSION_06[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][3]
state_data2020$DEPRESSION_07[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][4]
state_data2020$DEPRESSION_08[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][5]
state_data2020$DEPRESSION_14[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][6]
state_data2020$DEPRESSION_18[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][7]
state_data2020$DEPRESSION_19[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][8]
state_data2020$DEPRESSION_20[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][9]
state_data2020$DEPRESSION_21[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][10]
state_data2020$DEPRESSION_26[state_data2020$ADDEPEV3 == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'depression'][11]


state_data2020$HEPB_00[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][1]
state_data2020$HEPB_01[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][2]
state_data2020$HEPB_02[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][3]
state_data2020$HEPB_03[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][4]
state_data2020$HEPB_13[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][5]
state_data2020$HEPB_14[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][6]
state_data2020$HEPB_18[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][7]
state_data2020$HEPB_19[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][8]
state_data2020$HEPB_22[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][9]
state_data2020$HEPB_24[state_data2020$HAVEHEPB == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][10]


state_data2020$HEPC_00[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][1]
state_data2020$HEPC_01[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][2]
state_data2020$HEPC_02[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][3]
state_data2020$HEPC_03[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][4]
state_data2020$HEPC_13[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][5]
state_data2020$HEPC_14[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][6]
state_data2020$HEPC_18[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][7]
state_data2020$HEPC_19[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][8]
state_data2020$HEPC_22[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][9]
state_data2020$HEPC_24[state_data2020$TOLDHEPC == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'hepatitis'][10]


state_data2020$HEART_00[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][1]
state_data2020$HEART_01[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][2]
state_data2020$HEART_02[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][3]
state_data2020$HEART_03[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][4]
state_data2020$HEART_04[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][5]
state_data2020$HEART_05[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][6]
state_data2020$HEART_06[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][7]
state_data2020$HEART_07[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][8]
state_data2020$HEART_08[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][9]
state_data2020$HEART_09[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][10]
state_data2020$HEART_11[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][11]
state_data2020$HEART_12[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][12]
state_data2020$HEART_13[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][13]
state_data2020$HEART_17[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][14]
state_data2020$HEART_18[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][15]
state_data2020$HEART_19[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][16]
state_data2020$HEART_20[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][17]
state_data2020$HEART_21[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][18]
state_data2020$HEART_22[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][19]
state_data2020$HEART_24[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][20]
state_data2020$HEART_26[state_data2020$X_MICHD == 1] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'heart'][21]


state_data2020$MULTICANCER_00[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][1]
state_data2020$MULTICANCER_01[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][2]
state_data2020$MULTICANCER_02[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][3]
state_data2020$MULTICANCER_03[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][4]
state_data2020$MULTICANCER_04[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][5]
state_data2020$MULTICANCER_05[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][6]
state_data2020$MULTICANCER_06[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][7]
state_data2020$MULTICANCER_08[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][8]
state_data2020$MULTICANCER_09[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][9]
state_data2020$MULTICANCER_11[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][10]
state_data2020$MULTICANCER_13[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][11]
state_data2020$MULTICANCER_14[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][12]
state_data2020$MULTICANCER_15[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][13]
state_data2020$MULTICANCER_16[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][14]
state_data2020$MULTICANCER_20[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][15]
state_data2020$MULTICANCER_21[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][16]
state_data2020$MULTICANCER_24[state_data2020$CNCRDIFF == '102' | state_data2020$CNCRDIFF == '103'] <- LM_WHOICD_KG_SORTED[,3][LM_WHOICD_KG_SORTED$word == 'cancer'][17]


multicancer2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,MULTICANCER_01,MULTICANCER_02,MULTICANCER_03,MULTICANCER_04,MULTICANCER_05,MULTICANCER_06,MULTICANCER_07,MULTICANCER_08,MULTICANCER_09,MULTICANCER_10,MULTICANCER_11,MULTICANCER_12,MULTICANCER_13,MULTICANCER_14,MULTICANCER_15,MULTICANCER_16,MULTICANCER_17,MULTICANCER_18,MULTICANCER_19,MULTICANCER_20,MULTICANCER_21,MULTICANCER_22,MULTICANCER_23,MULTICANCER_24,MULTICANCER_25,MULTICANCER_26))

multicancer <- rbind(multicancer2020, multicancer)

#write.csv(multicancer, "LLCP2021XPT_MULTICANCER.csv")


heart2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,HEART_01,HEART_02,HEART_03,HEART_04,HEART_05,HEART_06,HEART_07,HEART_08,HEART_09,HEART_10,HEART_11,HEART_12,HEART_13,HEART_14,HEART_15,HEART_16,HEART_17,HEART_18,HEART_19,HEART_20,HEART_21,HEART_22,HEART_23,HEART_24,HEART_25,HEART_26))


heart <- rbind(heart2020,heart)

#write.csv(heart, "LLCP2021XPT_HEART.csv")

gender_weight2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,WEIGHT_01,WEIGHT_02,WEIGHT_03,WEIGHT_04,WEIGHT_05,WEIGHT_06,WEIGHT_07,WEIGHT_08,WEIGHT_09,WEIGHT_10,WEIGHT_11,WEIGHT_12,WEIGHT_13,WEIGHT_14,WEIGHT_15,WEIGHT_16,WEIGHT_17,WEIGHT_18,WEIGHT_19,WEIGHT_20,WEIGHT_21,WEIGHT_22,WEIGHT_23,WEIGHT_24,WEIGHT_25,WEIGHT_26))

gender_weight <- rbind(gender_weight2020,gender_weight)

write.csv(gender_weight, "LLCP2021XPT_GENDER_WEIGHT.csv")


gender_stress2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,STRESS_01,STRESS_02,STRESS_03,STRESS_04,STRESS_05,STRESS_06,STRESS_07,STRESS_08,STRESS_09,STRESS_10,STRESS_11,STRESS_12,STRESS_13,STRESS_14,STRESS_15,STRESS_16,STRESS_17,STRESS_18,STRESS_19,STRESS_20,STRESS_21,STRESS_22,STRESS_23,STRESS_24,STRESS_25,STRESS_26))

gender_stress <- rbind(gender_stress2020,gender_stress)

#write.csv(gender_stress, "LLCP2021XPT_GENDER_STRESS.csv")

gender_injury_fatigue2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

gender_injury_fatigue <- rbind(gender_injury_fatigue2020,gender_injury_fatigue)

write.csv(gender_injury_fatigue, "LLCP2021XPT_GENDER_INJURY_FATIGUE.csv")


injury_fatigue2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,INJURY_01,INJURY_02,INJURY_03,INJURY_04,INJURY_05,INJURY_06,INJURY_07,INJURY_08,INJURY_09,INJURY_10,INJURY_11,INJURY_12,INJURY_13,INJURY_14,INJURY_15,INJURY_16,INJURY_17,INJURY_18,INJURY_19,INJURY_20,INJURY_21,INJURY_22,INJURY_23,INJURY_24,INJURY_25,INJURY_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

injury_fatigue <- rbind(injury_fatigue2020,injury_fatigue)

#write.csv(injury_fatigue, "LLCP2021XPT_INJURY_FATIGUE.csv")

diabetes2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,LABEL_01,LABEL_02,LABEL_03,LABEL_04,LABEL_05,LABEL_06,LABEL_07,LABEL_08,LABEL_09,LABEL_10,LABEL_11,LABEL_12,LABEL_13,LABEL_14,LABEL_15,LABEL_16,LABEL_17,LABEL_18,LABEL_19,LABEL_20,LABEL_21,LABEL_22,LABEL_23,LABEL_24,LABEL_25,LABEL_26,PDTEST_01,PDTEST_02,PDTEST_03,PDTEST_04,PDTEST_05,PDTEST_06,PDTEST_07,PDTEST_08,PDTEST_09,PDTEST_10,PDTEST_11,PDTEST_12,PDTEST_13,PDTEST_14,PDTEST_15,PDTEST_16,PDTEST_17,PDTEST_18,PDTEST_19,PDTEST_20,PDTEST_21,PDTEST_22,PDTEST_23,PDTEST_24,PDTEST_25,PDTEST_26))

diabetes <- rbind(diabetes2020,diabetes)

write.csv(diabetes, "LLCP2021XPT_DIABETES.csv")

gender_fatigue2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,GENDER_01,GENDER_02,GENDER_03,GENDER_04,GENDER_05,GENDER_06,GENDER_07,GENDER_08,GENDER_09,GENDER_10,GENDER_11,GENDER_12,GENDER_13,GENDER_14,GENDER_15,GENDER_16,GENDER_17,GENDER_18,GENDER_19,GENDER_20,GENDER_21,GENDER_22,GENDER_23,GENDER_24,GENDER_25,GENDER_26,FATIGUE_01,FATIGUE_02,FATIGUE_03,FATIGUE_04,FATIGUE_05,FATIGUE_06,FATIGUE_07,FATIGUE_08,FATIGUE_09,FATIGUE_10,FATIGUE_11,FATIGUE_12,FATIGUE_13,FATIGUE_14,FATIGUE_15,FATIGUE_16,FATIGUE_17,FATIGUE_18,FATIGUE_19,FATIGUE_20,FATIGUE_21,FATIGUE_22,FATIGUE_23,FATIGUE_24,FATIGUE_25,FATIGUE_26))

gender_fatigue <- rbind(gender_fatigue2020,gender_fatigue)

#write.csv(smoke, "LLCP2021XPT_GENDER_FATIGUE.csv")


smoke2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,SMOKE_01,SMOKE_02,SMOKE_03,SMOKE_04,SMOKE_05,SMOKE_06,SMOKE_07,SMOKE_08,SMOKE_09,SMOKE_10,SMOKE_11,SMOKE_12,SMOKE_13,SMOKE_14,SMOKE_15,SMOKE_16,SMOKE_17,SMOKE_18,SMOKE_19,SMOKE_20,SMOKE_21,SMOKE_22,SMOKE_23,SMOKE_24,SMOKE_25,SMOKE_26))

smoke <- rbind(smoke2020,smoke)

write.csv(smoke, "LLCP2021XPT_SMOKE.csv")


alcohol2020 = subset(state_data2020, select = c(CNCRTYP1,CNCRDIFF,X_SEX,DRINK_01,DRINK_02,DRINK_03,DRINK_04,DRINK_05,DRINK_06,DRINK_07,DRINK_08,DRINK_09,DRINK_10,DRINK_11,DRINK_12,DRINK_13,DRINK_14,DRINK_15,DRINK_16,DRINK_17,DRINK_18,DRINK_19,DRINK_20,DRINK_21,DRINK_22,DRINK_23,DRINK_24,DRINK_25,DRINK_26))

alcohol <- rbind(alcohol2020,alcohol)

write.csv(alcohol, "LLCP2021XPT_ALCOHOL.csv")
